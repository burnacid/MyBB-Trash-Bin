...
function trashbin_uninstall()
{
    ...
    if ($mybb->request_method != 'post')
    {
        ...
        $page->output_confirm_action(
            'index.php?module=config-plugins&action=deactivate&uninstall=1&plugin=trashbin',
            "Are you sure you want to uninstall the Trash bin plugin? This will delete the complete contents of the trashbin.",
            "Uninstall Trashbin plugin"
        );
    }
...
function trashbin_tools_action_handler(&$actions)
{
